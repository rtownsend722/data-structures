describe('doublyLinkedList', function() {
  ...
  it('should contain a head when remove head is called', function() {
  ...
  it('should add head to the front of the list', function() {
  ...
  it('should point nodes to the correct previous value', function() {
    doublyLinkedList.addToTail(2);
    doublyLinkedList.addToTail(3);
    doublyLinkedList.addToTail(4);
